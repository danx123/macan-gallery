...
APP_VERSION = "1.3.0" # [PERUBAHAN] Versi diperbarui dengan fitur fit-to-window dan pan mode
...
class MacanGallery(QMainWindow):
    def __init__(self):
        ...
        # [PENAMBAHAN] Variabel untuk state pan mode
    ...
    def init_ui(self):
        ...
        # [PENAMBAHAN] Instalasi event filter untuk pan mode
    ...
    # [PERUBAHAN] Diperbarui untuk fitur fit-to-window saat membuka gambar
    def show_image_view(self, path):
        try:
            ...
            # [PERUBAHAN] Set gambar kosong dulu, lalu panggil fit-to-window setelah UI siap
    ...
    # [PENAMBAHAN] Fungsi baru untuk menyesuaikan gambar ke ukuran jendela
    ...
    # [PERUBAHAN] Logika zoom diperbarui untuk menangani pan mode
    ...
    # [PENAMBAHAN] Fungsi baru untuk mengelola kursor pan mode
    ...
    # [PENAMBAHAN] Event filter untuk menangani mouse events untuk pan mode
    ...
    def resizeEvent(self, event):
        ...
        if self.main_stack.currentIndex() == 1 and self.current_viewer_pixmap:
             # [PERUBAHAN] Gunakan logika zoom yang sama saat resize dan update cursor
