...
APP_VERSION = "2.0.0" # [PERUBAHAN] Versi diperbarui dengan fitur-fitur profesional
...
class MacanGallery(QMainWindow):
    ...
    def init_ui(self):
        ...
        viewer_layout.addWidget(self.viewer_toolbar)
    ...
    def apply_stylesheet(self):
        self.setStyleSheet("""
            ...
            QToolBar#viewerToolbar { border-bottom: none; border-top: 1px solid #4C566A; }
    ...
    def create_viewer_toolbar(self):
        ...
        flip_h_svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22V2M3 12l9-9 9 9-9 9-9-9z"/></svg>'.replace('d="M12 22V2M3 12l9-9 9 9-9 9-9-9z"', 'd="M3 12h18M12 22V2"')
        flip_v_svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12H2M12 3l9 9-9 9-9-9 9-9z"/></svg>'.replace('d="M22 12H2M12 3l9 9-9 9-9-9 9-9z"', 'd="M22 12H2M12 3v18"')
