...
APP_VERSION = "1.2.0" # [PERUBAHAN] Versi diperbarui dengan fitur zoom dan lainnya
...
class MacanGallery(QMainWindow):
    ...
    def apply_stylesheet(self):
        self.setStyleSheet("""
            ...
            /* [PENAMBAHAN] Style untuk QSlider di status bar */
    ...
    # [PERUBAHAN] Modifikasi status bar untuk menampung widget baru
    def create_status_bar(self):
        self.statusbar = self.statusBar()
        self.status_label = QLabel("Ready")
        self.statusbar.addWidget(self.status_label, 1)

        # [PENAMBAHAN] Widget untuk informasi file gambar
    ...
    # [PERUBAHAN] Diperbarui untuk menampilkan info file dan kontrol zoom
    def show_image_view(self, path):
        try:
            ...
            # [PENAMBAHAN] Tampilkan info file & kontrol zoom di status bar
    ...
    # [PERUBAHAN] Diperbarui untuk menyembunyikan info file dan kontrol zoom
    def show_gallery_view(self):
        self.main_stack.setCurrentIndex(0)
        self.current_viewer_pixmap = None
        self.viewer_label.clear()

        # [PENAMBAHAN] Sembunyikan info & kontrol zoom
        self.image_res_label.hide()
        self.image_file_type_label.hide()
        self.image_size_label.hide()
    ...
    # [PERUBAHAN] Menambahkan opsi 'Remove from list' untuk folder
    def show_context_menu(self, pos):
        ...
        if isinstance(thumb_widget, ThumbnailWidget):
            ...
            set_wallpaper_action.triggered.connect(lambda: self.set_as_wallpaper(thumb_widget.file_path))
             ...
             # [PENAMBAHAN] Menu konteks baru untuk folder
             context_menu.addSeparator()
    ...
    # [PENAMBAHAN] Fungsi untuk menghapus folder dari daftar galeri
    ...
    def resizeEvent(self, event):
        ...
        if self.main_stack.currentIndex() == 1 and self.current_viewer_pixmap:
             # [PERUBAHAN] Gunakan logika zoom yang sama saat resize
